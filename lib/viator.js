...
export async function fetchViatorTours({ city, count = 9, revalidateSeconds = 60 * 60 * 12 }) {
  ...
  try {
    ...
    if (process.env.NODE_ENV === 'development' || error.message.includes('fetch failed') || error.message.includes('ENOTFOUND')) {
      ...
      const mockTours = [
        {
          ...
          description: "Experience the natural beauty of Wenzhou with a private day tour to Yandang Mountain, known for its dramatic peaks and scenic landscapes. Visit a traditional tea plantation and learn about the art of tea making while enjoying panoramic views of the countryside. This comprehensive tour includes a professional guide, transportation, and tea tasting experience.",
          images: [{
        ...
        },
        {
          ...
          description: "Discover the rich history and culture of Wenzhou on this guided walking tour through the old city. Visit ancient temples, traditional architecture, and local markets while learning about the city's fascinating past from your knowledgeable guide.",
          images: [{
            variants: [null, null, null, {
        ...
        },
        {
          ...
          description: "Immerse yourself in Wenzhou's culinary scene with this food-focused tour. Sample local specialties, visit traditional markets, and learn about the unique flavors that define Wenzhou cuisine. Perfect for food lovers and cultural enthusiasts.",
          images: [{
            variants: [null, null, null, {
