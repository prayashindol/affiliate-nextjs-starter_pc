...
// Content thresholds for conservative processing
const SHORT_ELEMENTOR_CONTENT_LENGTH_THRESHOLD = 20000;
...
export function fixViatorHtml(htmlContent) {
  ...
  const isShortElementorContent = htmlContent.length < SHORT_ELEMENTOR_CONTENT_LENGTH_THRESHOLD && 
