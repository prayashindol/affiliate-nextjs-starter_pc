...
const mockViatorPost = {
  ...
  contentHtml: `
    <p>London is one of the world's most exciting cities, offering an incredible blend of history, culture, and modern attractions.</p>
    <p>From iconic landmarks like Big Ben and the Tower of London to hidden gems in charming neighborhoods, London has something for every type of traveler.</p>
    <h2>Top Tourist Attractions in London</h2>
    <p>The Tower of London houses the Crown Jewels and centuries of fascinating history, while Westminster Abbey has been the site of countless royal ceremonies.</p>
    <ul>
    ...
    <p>The London Eye offers breathtaking 360-degree views of the city, especially stunning at sunset.</p>
    <h2>Best Areas to Stay in London</h2>
    <p>Central areas like Covent Garden and South Kensington offer easy access to major attractions, while areas like Shoreditch provide vibrant nightlife and food scenes.</p>
    <p>For first-time visitors, staying near Zone 1 tube stations is recommended.</p>
    <h2>Getting Around London</h2>
    <p>London's public transportation system is one of the world's best. The Underground (Tube) connects virtually every corner of the city.</p>
  `,
  dateModified: '2024-01-15',
  datePublished: '2024-01-10',
  author: 'Travel Expert',
  description:
    "Discover the best things to do in London with our comprehensive travel guide. From iconic landmarks to hidden gems, find everything you need for an unforgettable visit.",
  excerpt:
    "Complete guide to London's top attractions, best neighborhoods, and travel tips for an amazing visit to the UK's capital city.",
...
export default async function ViatorTestPage() {
  // Keep the same structure, but ensure types align with ViatorGenPost prop
  ...
  try {
    const isViatorPost =
      ...
      (Array.isArray(mockViatorPost.category) &&
        mockViatorPost.category.includes('airbnb-gen-viator'));
    ...
    if (isViatorPost && mockViatorPost.city) {
      ...
      debugInfo.toursFound = (viatorTours as unknown[]).length;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto mb-8 px-4">
        {(viatorTours as unknown[]).length > 0 ? (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <h3 className="text-green-800 font-semibold mb-2">✅ Viator Integration Working!</h3>
            <p className="text-green-700">
              Successfully fetched {(viatorTours as unknown[]).length} tours for {mockViatorPost.city}.
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <p className="text-red-700">No tours were fetched. This could indicate:</p>
      ...
      <ViatorGenPost
        post={mockViatorPost}
        // The assertion below aligns with the ViatorGenPost prop type (which currently infers never[])
        viatorTours={viatorTours as never[]}
        city={mockViatorPost.city}
      />
      ...
      <div className="max-w-4xl mx-auto mt-12 p-4 bg-gray-100 rounded-lg text-sm text-gray-600">
        <p>
          <strong>Test Page Info:</strong> This page bypasses Sanity CMS and uses mock post data to test
          only the Viator tours integration. If tours appear above, the integration is working correctly.
        </p>
      </div>
    </div>
  );
